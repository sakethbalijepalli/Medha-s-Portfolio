      ...
      <div className="container mx-auto px-6">
        ...
        {hasShows ? (
          ...
          <div className="text-center py-24">
            <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-gold-50 dark:bg-gold-900/20 border border-gold-200 dark:border-gold-800 flex items-center justify-center">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-light text-gray-900 dark:text-white mb-3">
              Stay Tuned
            </h2>
            <p className="text-gray-500 dark:text-gray-400 text-base max-w-sm mx-auto leading-relaxed">
              New performances are being planned. Subscribe below to be the first to know when dates are announced.
            </p>
          </div>
        )}
